...
<div align="center">
  <img src="docs/images/realtime-caching-gateway-architecture.png" alt="Realtime Caching Gateway Architecture" width="960" />
</div>

<div align="center">
  <sub>
    Source:
    <a href="docs/diagram/realtime-caching-gateway-architecture.drawio">draw.io</a> ·
    <a href="docs/pdf/realtime-caching-gateway-architecture.pdf">PDF</a>
  </sub>
</div>
...
<div align="center">
  <img src="docs/images/cache-recovery-flow.png" alt="Cache Recovery Flow" width="960" />
</div>

<div align="center">
  <sub>
    Source:
    <a href="docs/diagram/cache-recovery-flow.drawio">draw.io</a> ·
    <a href="docs/pdf/cache-recovery-flow.pdf">PDF</a>
  </sub>
</div>
...
|---|---|---|---|
| Health API | Redis / PostgreSQL 연결 상태 확인 가능 | Pass | `docs/test-report.md` |
| Message Save API | 다양한 메시지 타입 저장 흐름 정상 동작 | Pass | `docs/test-report.md` |
| Message Query API | recent / before / after 조회 정상 동작 | Pass | `docs/test-report.md` |
| Conversation Meta API | meta 조회 요청 정상 처리 | Pass | `docs/test-report.md` |
| Full Miss Fallback | Redis miss 시 PostgreSQL fallback 후 조회 가능 | Pass | `docs/test-report.md` |
| Partial Miss Recovery | 일부 message hash 유실 시 복구 후 응답 정상화 | Pass | `docs/test-report.md` |
| Meta Recovery | `conversation_state` 기반 meta 재구성 가능 | Pass | `docs/test-report.md` |
| Redis → PostgreSQL Sync | dirty conversation 기반 scheduled sync 수행 | Pass | `docs/test-report.md` |
| CI regression check | build / test 자동화 기반 기본 회귀 확인 | Pass | GitHub Actions |

### Example Recovery Log

```text
[Query API] conversationId=room-1001
[Redis] Recent message index found
[Redis] Partial miss detected for messageId=msg-103
[PostgreSQL] Fallback query executed
[Recovery] Missing messages restored to Redis
[Meta] Conversation meta rebuilt
[Query API] Response returned successfully
```
...
<table width="100%">
  <tr>
    <td width="50%" align="center" valign="top">
      <img src="docs/images/test-report-summary.png" alt="Test Report Summary" height="220" />
    </td>
    <td width="50%" align="center" valign="top">
  ...
  <tr>
    <td width="50%" align="center" valign="top">
      <img src="docs/images/test-health-api.png" alt="Test Health API" height="220" />
    </td>
    <td width="50%" align="center" valign="top">
      <img src="docs/images/test-message-api.png" alt="Test Message API" height="220" />
    </td>
  </tr>
  <tr>
    <td width="50%" align="center" valign="top">
      <img src="docs/images/test-message-recovery.png" alt="Test Message Recovery" height="220" />
    </td>
    <td width="50%" align="center" valign="top">
    </td>
  </tr>
...
- Redis를 **실시간 처리 계층 + 캐시 계층**으로 사용하면서도, PostgreSQL fallback으로 복구 가능성을 확보했습니다.
- full miss / partial miss / meta miss를 **예외가 아닌 recovery flow**로 다루는 구조를 검증했습니다.
- dirty conversation 기반 synchronization으로 **최종 정합성까지 고려한 구조**를 설명할 수 있습니다.
